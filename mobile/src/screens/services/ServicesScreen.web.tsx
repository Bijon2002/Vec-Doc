...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Dimensions, Alert, Image, ActivityIndicator, Platform } from 'react-native';
...
export default function ServicesScreenWeb() {
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            {/* Map Section - Placeholder for web */}
